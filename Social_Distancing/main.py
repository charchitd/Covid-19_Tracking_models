...
output_movie = cv2.VideoWriter("SocialDist_detect.avi", fourcc, fps, (width, height))
...
while cap.isOpened():
    ...
    last_h = 75
    text = "# 1m violations: " + str(int(total_six_feet_violations))
    ...
    cv2.imshow("Frame", pedestrian_detect)
    cv2.waitKey(1)
